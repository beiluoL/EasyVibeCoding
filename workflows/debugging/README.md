...
| 检查点 | 原因 | 谁来拍板 |
| --- | --- | --- |
| 根因找到后、动手修前 | AI 可能误判根因，直接修会改错地方 | 人确认根因 |
| 修复涉及多个模块时 | 改动面变大，可能引入新 Bug | 人确认修复范围 |
| 回归测试有失败时 | 说明修复影响了其他功能，不能直接提交 | 人决定是继续修还是回退 |

> 💡 原则：超过 3 轮没修好就停——回 systematic-debugging 的 6 步重新定位根因，不要无限循环。
