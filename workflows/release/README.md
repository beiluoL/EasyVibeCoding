...
| 检查点 | 原因 | 谁来拍板 |
| --- | --- | --- |
| 发布清单完成后（Step 1 结束） | 清单决定发布范围，AI 可能漏掉环境变量/迁移/权限 | 人确认发布清单 |
| Staging 环境验证后（Step 3 结束） | Staging 是最后一道防线，不验就上生产 = 赌 | 人确认 staging 全绿 |
| 生产部署前 | 一旦上生产就不可逆，必须人确认可以发布 | 人最终签发 |

> 💡 原则 05 Human owns decisions——发布是不可逆操作，每个检查点都必须人确认，AI 不能自作主张发版。
