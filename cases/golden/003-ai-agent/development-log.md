...
链：[skills/ai/tool-calling.md](../../../skills/ai/tool-calling/SKILL.md)
...
链：[prompts/agent-planner.md](../../../prompts/ai-app/build-agent.md)

## Step 4 Tool Caller
解析 Planner 输出的 JSON，按 schema 校验后执行。
链：[skills/ai/agent.md](../../../skills/ai/agent/SKILL.md)
...
链：[prompts/agent-summary.md](../../../prompts/ai-app/build-agent.md)
